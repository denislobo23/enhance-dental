...
export const metadata = {
  title: "Veneers Toorak | Cosmetic Veneers Consultation",
  description:
    "Explore veneers in Toorak including cosmetic smile consultations, veneer suitability, FAQs, and treatment pathways.",
};

export default function ToorakVeneersPage() {
  return (
    <main className="min-h-screen bg-[#fbfaf7] text-slate-950">
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <h1 className="mt-4 text-5xl font-semibold tracking-tight md:text-6xl">
              Premium veneers consultations for patients in Toorak.
            </h1>

            <p className="mt-6 max-w-xl text-lg leading-8 text-slate-600">
              Veneers are commonly explored by patients wanting a brighter,
              more balanced smile with a natural and refined appearance.
            </p>

            <p className="mt-5 max-w-xl leading-8 text-slate-600">
              Patients from Toorak may explore veneers as part of cosmetic
              smile planning involving tooth colour, shape, symmetry,
              alignment, or overall smile confidence.
            </p>
          ...
          <div className="overflow-hidden rounded-[2rem] border border-[#e7dfd3] bg-white shadow-sm">
            <div className="relative aspect-[4/5]">
              <Image
                ...
                alt="Premium veneers consultation Toorak"
                fill
      ...
      <section className="mx-auto max-w-5xl px-6 pb-12">
        <div className="rounded-[2rem] border border-[#d7e7f2] bg-white p-8 shadow-sm">
          ...
          <p className="mt-6 leading-8 text-slate-600">
            Veneers are thin coverings bonded to the front surface of teeth to
            improve the appearance of colour, shape, symmetry, spacing, or
            overall smile aesthetics.
          </p>

          <p className="mt-5 leading-8 text-slate-600">
            Patients in Toorak often explore veneers when looking for a more
            polished, balanced, and confident smile while maintaining a natural
            appearance.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-12">
        <div className="mb-8 max-w-3xl">
          ...
          <h2 className="mt-4 text-4xl font-semibold tracking-tight">
            Cosmetic smile planning designed around facial balance and natural aesthetics.
          </h2>
          ...
          {[
            {
              ...
              text: "Consultation may involve discussing smile goals, facial balance, and cosmetic preferences.",
            },
            {
              image: "/images/enhance-dental/veneers-2.jpg",
              title: "Veneers Planning",
              text: "Patients often explore veneer shape, brightness, symmetry, and natural appearance.",
            },
            {
              image: "/images/enhance-dental/veneers-3.jpg",
              title: "Confidence & Lifestyle",
              text: "Many patients seek veneers to feel more confident professionally and socially.",
            },
          ].map((item) => (
            <div
              key={item.title}
      ...
      <section className="mx-auto max-w-5xl px-6 pb-12">
        <div className="rounded-[2rem] border border-[#d7e7f2] bg-[#f7fbff] p-8 shadow-sm">
          <h2 className="text-3xl font-semibold">
            Why patients in Toorak explore veneers
          </h2>

          <div className="mt-8 grid gap-5 md:grid-cols-2">
            {[
              "To improve smile symmetry and tooth proportions.",
              "To reduce the appearance of staining or discoloration.",
              "To create a more polished and refined smile.",
              "To improve confidence in social or professional settings.",
              "To explore cosmetic smile enhancement as part of a broader makeover.",
        ...
        <div className="grid gap-6">
          {[
            ...
            },
            {
              ...
              answer:
                "Suitability and treatment approach vary between patients. Consultation helps determine the most appropriate pathway.",
            },
            {
              question: "Can veneers improve confidence?",
              answer:
                "Many patients explore veneers because they feel more confident smiling in personal, professional, and social settings.",
            },
          ].map((item) => (
            <div
              key={item.question}
      ...
      <section className="mx-auto max-w-5xl px-6 pb-12">
        <div className="rounded-[2rem] bg-[#0b376d] p-10 text-white shadow-sm">
          <h2 className="text-4xl font-semibold tracking-tight">
            Explore veneers consultations for patients in Toorak.
          </h2>

          <p className="mt-6 max-w-2xl leading-8 text-blue-100">
            Consultation can help clarify veneer options, smile goals,
            suitability, and cosmetic planning pathways.
          </p>
      ...
      <section id="toorak-enquiry" className="bg-white px-6 pb-12 pt-0">
        <div className="mx-auto grid max-w-5xl gap-10 lg:grid-cols-2">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.25em] text-[#0b70b7]">
              Toorak Veneers Enquiry
            </p>
          ...
          >
            <input type="hidden" name="page" value="Toorak Veneers Page" />
