...
export const metadata = {
  title: "Veneers South Yarra | Cosmetic Veneers Consultation",
  description:
    "Explore veneers consultations for patients in South Yarra including cosmetic smile planning, veneer suitability, and treatment pathways.",
};

export default function SouthYarraVeneersPage() {
  return (
    <main className="min-h-screen bg-[#fbfaf7] text-slate-950">
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <h1 className="mt-4 text-5xl font-semibold tracking-tight md:text-6xl">
              Cosmetic veneers consultations for patients in South Yarra.
            </h1>

            <p className="mt-6 max-w-xl text-lg leading-8 text-slate-600">
              Veneers are commonly explored by patients wanting a brighter,
              more balanced smile while maintaining a natural and refined look.
            </p>

            <p className="mt-5 max-w-xl leading-8 text-slate-600">
              Patients from South Yarra may explore veneers as part of cosmetic
              smile enhancement involving tooth colour, symmetry, spacing,
              alignment, or overall smile confidence.
            </p>

            <a
              href="#south-yarra-enquiry"
          ...
          <div className="overflow-hidden rounded-[2rem] border border-[#e7dfd3] bg-white shadow-sm">
            <div className="relative aspect-[4/5]">
              <Image
                ...
                alt="South Yarra veneers consultation"
                fill
      ...
      <section className="mx-auto max-w-5xl px-6 pb-12">
        <div className="rounded-[2rem] border border-[#d7e7f2] bg-white p-8 shadow-sm">
          ...
          <p className="mt-6 leading-8 text-slate-600">
            ...
            teeth to improve the appearance of colour, shape, symmetry,
            spacing, and overall smile aesthetics.
          </p>

          <p className="mt-5 leading-8 text-slate-600">
            Patients in South Yarra often explore veneers when seeking a more
            polished, confident, and natural-looking smile.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-12">
        <div className="mb-8 max-w-3xl">
          ...
          <h2 className="mt-4 text-4xl font-semibold tracking-tight">
            Veneers designed around natural aesthetics and facial balance.
          </h2>
          ...
          {[
            {
              ...
              text: "Consultation may involve discussing cosmetic goals, smile proportions, and natural appearance.",
            },
            {
              image: "/images/enhance-dental/veneers-2.jpg",
              title: "Veneers Planning",
              text: "Patients often explore veneer shape, brightness, symmetry, and smile balance.",
            },
            {
              image: "/images/enhance-dental/veneers-3.jpg",
              title: "Lifestyle Confidence",
              text: "Many patients explore veneers to feel more comfortable smiling socially and professionally.",
            },
          ].map((item) => (
            <div
              key={item.title}
      ...
      <section className="mx-auto max-w-5xl px-6 pb-12">
        <div className="rounded-[2rem] border border-[#d7e7f2] bg-[#f7fbff] p-8 shadow-sm">
          <h2 className="text-3xl font-semibold">
            Why patients in South Yarra explore veneers
          </h2>
          ...
          <div className="mt-8 grid gap-5 md:grid-cols-2">
            {[
              ...
              "To create a brighter and more refined smile.",
              "To improve confidence in professional and social settings.",
        ...
        <div className="grid gap-6">
          {[
            ...
            },
            {
              ...
              answer:
                "Many patients explore veneers because they feel more confident smiling in social and professional settings.",
            },
            {
      ...
      <section className="mx-auto max-w-5xl px-6 pb-12">
        <div className="rounded-[2rem] bg-[#0b376d] p-10 text-white shadow-sm">
          <h2 className="text-4xl font-semibold tracking-tight">
            Explore veneers consultations for patients in South Yarra.
          </h2>
      ...
      <section
        id="south-yarra-enquiry"
        className="bg-white px-6 pb-12 pt-0"
      >
        <div className="mx-auto grid max-w-5xl gap-10 lg:grid-cols-2">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.25em] text-[#0b70b7]">
              South Yarra Veneers Enquiry
            </p>
          ...
          >
            <input
              type="hidden"
              name="page"
              value="South Yarra Veneers Page"
            />
