...
export const metadata = {
  title: "Veneers Malvern | Cosmetic Veneers Consultation",
  description:
    "Explore veneers consultations for patients in Malvern including cosmetic smile planning, veneer suitability, and treatment pathways.",
};

export default function MalvernVeneersPage() {
  return (
    <main className="min-h-screen bg-[#fbfaf7] text-slate-950">
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <h1 className="mt-4 text-5xl font-semibold tracking-tight md:text-6xl">
              Premium veneers consultations for patients in Malvern.
            </h1>

            <p className="mt-6 max-w-xl text-lg leading-8 text-slate-600">
              Veneers are commonly explored by patients wanting a brighter,
              more balanced smile while maintaining a natural and elegant look.
            </p>

            <p className="mt-5 max-w-xl leading-8 text-slate-600">
              Patients from Malvern may explore veneers as part of cosmetic
              smile enhancement involving colour, shape, symmetry, spacing,
              and overall smile aesthetics.
            </p>

            <a
              href="#malvern-enquiry"
          ...
          <div className="overflow-hidden rounded-[2rem] border border-[#e7dfd3] bg-white shadow-sm">
            <div className="relative aspect-[4/5]">
              <Image
                ...
                alt="Malvern veneers consultation"
                fill
      ...
      <section className="mx-auto max-w-5xl px-6 pb-12">
        <div className="rounded-[2rem] border border-[#d7e7f2] bg-white p-8 shadow-sm">
          ...
          <p className="mt-6 leading-8 text-slate-600">
            ...
            symmetry, and overall smile balance.
          </p>

          <p className="mt-5 leading-8 text-slate-600">
            Patients in Malvern often explore veneers when seeking a more
            refined, polished, and confident smile appearance.
          </p>
        </div>
      </section>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {[
            ...
            },
            {
              ...
              text: "Patients often explore veneer brightness, symmetry, proportions, and natural aesthetics.",
            },
            {
              image: "/images/enhance-dental/veneers-3.jpg",
              title: "Confidence & Lifestyle",
              text: "Many patients explore veneers to feel more confident smiling socially and professionally.",
            },
          ].map((item) => (
            <div
              key={item.title}
      ...
      <section className="mx-auto max-w-5xl px-6 pb-12">
        <div className="rounded-[2rem] border border-[#d7e7f2] bg-[#f7fbff] p-8 shadow-sm">
          <h2 className="text-3xl font-semibold">
            Why patients in Malvern explore veneers
          </h2>

          <div className="mt-8 grid gap-5 md:grid-cols-2">
            {[
              "To improve smile symmetry and proportions.",
              "To reduce the appearance of staining or discoloration.",
              "To create a brighter and more refined smile.",
              "To improve confidence in social and professional settings.",
        ...
        <div className="grid gap-6">
          {[
            ...
            },
            {
              ...
              answer:
                "Many patients explore veneers because they feel more comfortable smiling in professional and social settings.",
            },
            {
      ...
      <section className="mx-auto max-w-5xl px-6 pb-12">
        <div className="rounded-[2rem] bg-[#0b376d] p-10 text-white shadow-sm">
          <h2 className="text-4xl font-semibold tracking-tight">
            Explore veneers consultations for patients in Malvern.
          </h2>
