...
export const metadata = {
  title: "Veneers Kew | Cosmetic Veneers Consultation",
  description:
    "Explore veneers consultations for patients in Kew including cosmetic smile planning, veneer suitability, and treatment pathways.",
};

export default function KewVeneersPage() {
  return (
    <main className="min-h-screen bg-[#fbfaf7] text-slate-950">
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <h1 className="mt-4 text-5xl font-semibold tracking-tight md:text-6xl">
              Cosmetic veneers consultations for patients in Kew.
            </h1>
            ...
            <p className="mt-5 max-w-xl leading-8 text-slate-600">
              Patients from Kew may explore veneers as part of cosmetic smile
              enhancement involving colour, symmetry, spacing, shape, and
      ...
      <section className="mx-auto max-w-5xl px-6 pb-12">
        <div className="rounded-[2rem] border border-[#d7e7f2] bg-white p-8 shadow-sm">
          ...
          <p className="mt-6 leading-8 text-slate-600">
            ...
            teeth to improve the appearance of colour, spacing, symmetry,
            proportions, and overall smile aesthetics.
          </p>

          <p className="mt-5 leading-8 text-slate-600">
            Patients in Kew often explore veneers when seeking a more polished,
            balanced, and confident smile appearance.
          </p>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-5xl px-6 pb-12">
        <div className="rounded-[2rem] border border-[#d7e7f2] bg-[#f7fbff] p-8 shadow-sm">
          <h2 className="text-3xl font-semibold">
            Why patients in Kew explore veneers
          </h2>
      ...
      <section className="mx-auto max-w-5xl px-6 pb-12">
        <div className="rounded-[2rem] bg-[#0b376d] p-10 text-white shadow-sm">
          <h2 className="text-4xl font-semibold tracking-tight">
            Explore veneers consultations for patients in Kew.
          </h2>
      ...
      <section id="kew-enquiry" className="bg-white px-6 pb-12 pt-0">
